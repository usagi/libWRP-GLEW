...
namespace detail {
  ...
  struct model_invoke_vertex_attribute_pointer_ final
  {
    ...
    static constexpr GL::GLenum type       = GL::GLenum(vertex_attribute_from_type<typename arrayed_information::type>::vertex_attribute);
  ...
  { static inline void invoke() { model_invoke_vertex_attribute_pointer_<0, true, TVERTEX>::invoke(); } };
